...
describe Resin::CLI, "execute" do
  ...
  it "should not accept phrases without FIM_DE_FRASE" do
    input_tests = ["SUJEITO", "SUBSTANTIVO", "SINTAGMA_VERBAL", "ARTIGO", "PRONOME", "CONECTIVO", "VERBO", "ADVERBIO",
                   "SINTAGMA_ADJETIVO", "SINTAGMA_ADJETIVO_SIMPLES", "SINTAGMA_SUBSTANTIVO", "SINTAGMA_SUBSTANTIVO_SIMPLES",
                   "SINTAGMA_ADVERBIAL", "SUBSTANTIVO CONECTIVO SUBSTANTIVO", "SUBSTANTIVO CONECTIVO SUBSTANTIVO CONECTIVO SUBSTANTIVO",
  ...
  it "should accept (ADVERBIO CONECTIVO)* SUJEITO (VERBO (ADVERBIO CONECTIVO?)*)? FIM_DE_FRASE" do
    input_tests = ["ADVERBIO CONECTIVO SUJEITO VERBO ADVERBIO FIM_DE_FRASE",
                   "ADVERBIO CONECTIVO SUJEITO FIM_DE_FRASE",
                   "SUJEITO VERBO ADVERBIO FIM_DE_FRASE",
                   "ADVERBIO CONECTIVO ADVERBIO CONECTIVO SUJEITO VERBO ADVERBIO CONECTIVO ADVERBIO FIM_DE_FRASE",
                   "ADVERBIO CONECTIVO ADVERBIO CONECTIVO SUJEITO FIM_DE_FRASE", "SUJEITO VERBO ADVERBIO CONECTIVO ADVERBIO FIM_DE_FRASE"]
    batch_test(input_tests, "")
  end

  it "should accept (ADVERBIO CONECTIVO?)+ FIM_DE_FRASE" do
    input_tests = ["ADVERBIO FIM_DE_FRASE", "ADVERBIO CONECTIVO ADVERBIO FIM_DE_FRASE",
                   "ADVERBIO CONECTIVO ADVERBIO CONECTIVO ADVERBIO FIM_DE_FRASE"]
    batch_test(input_tests, "")
  end
